    ...
    <>
            ...
            <div>
              ...
              <div className="lg:w-[570px]">
                ...
                <p className="text_para">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit quo animi voluptate, expedita voluptatum facilis culpa beatae dicta provident a facere iure, quae iste praesentium sequi quidem.
                </p>
      ...
      <section>
        ...
        <div className='container'>
          ...
          {/* How to approach, working of web */}
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] lg:mt-[55px]'>
            ...
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                <Link to='/doctors' className='h-[44px] w-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center justify-center group hover:bg-primaryColor hover:border-none'>
